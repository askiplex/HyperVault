...
// Load the shared grounded assistant on every page that uses this site script.
(() => {
  if (document.querySelector('script[data-hv-chatbot-script]')) return;
  const siteScript = document.currentScript;
  const chatbotScript = document.createElement('script');
  chatbotScript.src = new URL('chatbot.js', siteScript?.src || window.location.href).href;
  chatbotScript.dataset.hvChatbotScript = '';
